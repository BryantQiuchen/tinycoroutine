...
void Processor::stop() { status_ = PRO_STOPPING; }

void Processor::join() { pLoop_->join(); }

void Processor::wakeUpEpoller() { timer_.wakeUp(); }
...
void Processor::killCurCo() { removedCo_.push_back(pCurCoroutine_); }
